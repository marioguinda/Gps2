...
import models.CampusPoint;

@SuppressWarnings("serial")
public class PantallaCampus extends JPanel{
	
	private Image image, redPoint, upmIcon;
	private Toolkit toolkit;
	private CampusPoint imgPoint;
	private Dimension size;
	
	public PantallaCampus(String imageURL){
	...
	public void setImgPoint(CampusPoint imgPoint) {
